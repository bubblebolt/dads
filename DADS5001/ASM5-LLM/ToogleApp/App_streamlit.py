...
# Database interaction (example code, you need to fill in your database details)
...
if st.button("Store Data"):
    ...
    INSERT INTO your_table (id, text, created_at)
    VALUES ({id}, {text}, {created_at})
    ").format(
        id=sql.Literal(data["id"]),
        text=sql.Literal(data["text"]),
        created_at=sql.Literal(data["created_at"])
    )
